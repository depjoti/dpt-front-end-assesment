...
//               <td>{flight.class[0][0]}</td>
//               <td>{flight.fareBasis[0][0]}</td>
//               <td>{`${flight.itineraries[0].segments[0].departure.iataCode}-${flight.itineraries[0].segments[1].arrival.iataCode}`}</td>
//               <td>{flight.itineraries[0].segments[0].departure.at}</td>
//               <td>{flight.itineraries[0].segments[1].arrival.at}</td>
//               <td>{flight.itineraries[0].duration}</td>
//               <td>{flight.price}</td>
//             </tr>
//           ))}
